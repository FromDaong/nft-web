            ...
            >
                ...
                <div style={{
                    ...
                    <h1 style={{
                            ...
                            fontSize:32,
                            fontStyle:"normal"
                        }}>114 <span style={{fontWeight:100, left:"10px"}}>Subscribers</span></h1>
                        <h1 style={{
                            fontWeight:500,
                            fontSize:32,
                            fontStyle:"normal"
                        }}> 12.2k <span style={{fontWeight:100, left:"10px"}}>Followers</span></h1>
                        <h1 style={{
                            fontWeight:500,
                            fontSize:32,
                            fontStyle:"normal"
                        }}> 6.5k <span style={{fontWeight:100, left:"10px"}}>Trits</span></h1>
                </div>
                <div style={{
                    display:"flex",
                    flexDirection:"row",
                    ...
                    <p style={{
                            ...
                            fontSize:32,
                            fontStyle:"normal"
                        }}>Lorem ipsum dolor sit amet consectetur. Tincidunt cras quisque lectus 
                        ornare sagittis duis fringilla laoreet. Quam ultrices mi nibh tellus massa
                        aliquam a malesuada.</p>
