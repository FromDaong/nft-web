...
const default_image = (
	<div tw={"w-full h-full flex items-center justify-center bg-[#ffd4da]"}>
		<svg
			width="64"
			height="64"
			viewBox="0 0 564 564"
		...
		<h1 tw={"text-[64px] font-bold mx-4"}>TreatDAO</h1>
	</div>
);
...
const nft_image = (id, name, description, price, seller) => (
	<div
		tw={
			"w-full h-full flex flex-col items-center justify-center bg-[#ffd4da] p-8 text-center"
		}
	>
		<div tw={"h-32 w-32 bg-white flex rounded-full mb-8"}></div>
		<div tw="flex flex-col gap-2 w-full items-center">
			<h1 tw="text-3xl font-bold my-0 text-center">{name}</h1>
			<p tw="text-base text-gray-700 my-0 text-center">
				https://treatnfts.com/post/nft/{id}
			</p>
		</div>
		<p tw="text-lg text-gray-700 text-center max-w-xl">{description}</p>
	</div>
);
