      ...
      <div className="about">
        <div className="hero">
          <div className="row d-flex align-items-center">
            ...
            <div className="mt-5 col-lg-5 hero-logo-container">
              <img src={"/assets/hero-logo.png"} alt="" />
            </div>
          </div>
        </div>
        <div className="white-tp-container">
          <div className="pt-1 subtitle-text">Hey you 👋</div>
          <div className="pb-3 secondary-text">
          ...
          <br />
          <div className="row">
            <div className="mt-3 col-lg-4 p2 mt-lg-0">
          ...
          <br />
          <div className="mt-5 row the-dao">
        ...
        <div className="mt-4 mb-5 white-tp-container">
            ...
            <div className="mt-2 col-md-8">
              <div className="secondary-text">
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <Button className="mt-4 font-bold text-white bg-primary">
                    <b>SWAP WITH 1INCH</b>
                  </Button>
                </a>
              </div>
            </div>
            <div className="mt-5 col-md-4 mt-lg-0">
              <img src={"/assets/pie.png"} alt="" className="px-5 logo w-100" />
            </div>
          </div>
        </div>
      </div>
