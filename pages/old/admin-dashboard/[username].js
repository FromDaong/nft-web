  ...
  return (
    <Layout>
      ...
      <div className="container my-nft-container">
        ...
        />
        {/* <div className="p-3 mt-4 white-tp-bg">
          <p className="mb-0 w-100" style={{ wordBreak: "break-word" }}>
            <b>Connected wallet address:</b>
            <div>{`${account}`}</div>
          </p>
        </div> */}

        <div className="pb-3 mt-2 white-tp-container">
          <div className="row">
            <h5 className="pb-3 col-md-6">
              <b>Username:</b>
              <br />
              {data.username}
            </h5>
          ...
          <div className="py-2 buttons row">
