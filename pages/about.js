        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <div className="secondary-text">
              ...
              hold $TREAT tokens. Once you hold our token you get to have a
              voice when it comes to making major decisions, introducing new
              features, or choosing new partnerships.
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="col-md-8 mt-2">
            <div className="secondary-text">
              <p>
                ...
                development, terms of service, and all other decisions. This has
                been made possible thanks to the introduction of $TREAT token
                which can be used to make governing decisions. The more tokens
                you own, the more voting power you get.
              </p>
              <p>
