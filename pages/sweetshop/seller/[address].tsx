...
const getListingsBySeller = (seller_address: string, page) => {
    return axios.get(`${apiEndpoint}/marketplace/nft/listings-by-seller?seller=${seller_address}&page=${page}`).then(res => res.data.data)
}
        ...
        <ApplicationLayout>
            <ApplicationFrame>
                ...
                <Container className={"flex py-12"}>
                    <Heading size={"xs"}>
                        Showing NFT's for seller ${address}
                    </Heading>
                </Container>
