          ...
          <div className="absolute bottom-0 ">
            <div className="p-4">
              ...
              <p className="mt-2 text-ellipsis line-clamp-2">
                From Dominican Republic and the web. Their work includes
                computer drawings, installations and audiovisuals. Founder of
                the experimental creators community El Cuarto Elástico.
              </p>
            </div>
