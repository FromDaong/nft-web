...
export default function ListingSection({title, href, children}) {
	return (
		<div className="px-4 my-24 md:px-8 ">
			...
			<div className="grid grid-cols-1 gap-4 mt-12 md:grid-cols-2 xl:grid-cols-3">
				{children}
			</div>
		</div>
	);
...
export const TreatNFTsInfinityScrollingContainer = ({children}) => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 place-content-center xl:grid-cols-4 2xl:grid-cols-5 gap-8">
			{children}
		</div>
	);
};
