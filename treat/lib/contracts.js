...
export class Contracts {
  ...
  setProvider(provider, networkId) {
    const setProvider = (contract, address) => {
      ...
      else console.error('Titty Contract Address not found in network', networkId, ". Address: ", address)
    }

    setProvider(this.treat, contractAddresses.treat[networkId])
    setProvider(this.treatNFTMinter, contractAddresses.treatNFTMinter[networkId])
